    ...
    <section className={styles.main}>
      <div className={styles.content}>
        ...
        <p className={styles.description}>
          ...
          Daria Kwiatkowska, and Ryan Latimer. Since then she has enjoyed
          creating new and exciting works for a variety of ensembles.
        </p>
        <p>
          She is primarily interested in the interaction of electronics and
          ensemble. Her current goals include deepening her understanding of
