...
import picTapestry from "../../../public/images/pax_tapestry.jpg";
import picHound from '../../../public/images/hound.JPG'
import pignoli from '../../../public/images/pignoli.JPG'
import signpost from '../../../public/images/signpost.JPG'
import thecups from '../../../public/images/thecups.jpg'
import windchimes from '../../../public/images/windchimes.JPG'
  ...
  return (
    <section className={styles.main}>
      <div className={styles.content}>
        ...
        <div className={styles.divider}><p>✣ 2025 residency ✣</p></div>
        <div className={styles.gallery}>
          <div className={styles.gallery1}>
            <Image className={styles.pic} src={picTapestry} height={400} width={300} alt="hanging tapestry of different materials"/>
            <Image className={styles.pic} src={thecups} height={400} width={300} alt="embossed metal plates"/>
          </div>
          <div className={styles.gallery2}>
            <Image className={styles.pic} src={picHound} height={200} width={300} alt="a scultpure made of corrogated steel and springs"/>
            <Image className={styles.pic} src={pignoli} height={200} width={300} alt="a bundle of long pinecones"/>
            <Image className={styles.pic} src={signpost} height={200} width={300} alt="a sculpture of whittled wood"/>
            <Image className={styles.pic} src={windchimes} height={200} width={300} alt="found materials strung on material as wind chimes"/>
          </div>
        </div>
